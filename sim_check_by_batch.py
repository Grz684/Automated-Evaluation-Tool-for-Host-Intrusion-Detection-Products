...
if __name__ == '__main__':
    ...
    db2 = sqlite3.connect('tencent_pf_test/tencent_cis_baseline_scan_items.db')
    cursor2 = db2.cursor()
    ...
    matched_pairs = find_best_matches(cn_desc_list, check_item_list, gpu_similarity_batch, similarity_threshold=0.5)
    print("匹配的句子对：")
